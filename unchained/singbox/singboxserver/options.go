...
func makeLogOptions(cfg config.Singbox) *option.LogOptions {
...
func makeDnsOptions(cfg config.Singbox) *option.DNSOptions {
...
func makeTlsOptions(cfg config.Reality) option.InboundTLSOptions {
