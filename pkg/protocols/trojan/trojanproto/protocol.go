...
func NewClientConn(conn net.Conn, key Key, destination M.Socksaddr) *ClientConn {
	return &ClientConn{
...
func NewClientPacketConn(conn net.Conn, key Key) *ClientPacketConn {
...
func ClientHandshakeRaw(conn net.Conn, key Key, command byte, destination M.Socksaddr, payload []byte) error {
...
func ClientHandshake(conn net.Conn, key Key, destination M.Socksaddr, payload []byte) error {
...
func ClientHandshakeBuffer(conn net.Conn, key Key, destination M.Socksaddr, payload *buf.Buffer) error {
...
func ClientHandshakePacket(conn net.Conn, key Key, destination M.Socksaddr, payload *buf.Buffer) error {
